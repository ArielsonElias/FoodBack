...
namespace FoodBack_Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser {
                    ...
                    UF = model.UF,
                    Cidade = model.Cidade,
                    BandeiraCartao = model.BandeiraCartao,
                    NumeroCartao = model.NumeroCartao,
                    VencimentoCartao = model.VencimentoCartao               
                };
        ...
        //
        // POST: /Account/AlterarPerfil
        [HttpPost]
        [Authorize]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> AlterarPerfil(AlterarPerfilViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                user.BandeiraCartao = model.BandeiraCartao;
                user.NumeroCartao = model.NumeroCartao;
                user.VencimentoCartao = model.VencimentoCartao;
