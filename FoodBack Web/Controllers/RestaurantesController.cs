...
namespace FoodBack_Web.Controllers
{
    public class RestaurantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Endereco")] Restaurante restaurante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Endereco")] Restaurante restaurante)
        {
            if (ModelState.IsValid)
            {
